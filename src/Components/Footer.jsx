        ...
        <div className="container py-5">
          <div className="row g-5">
            <div className="col-lg-4 col-md-6">
              ...
              <p className="mb-2">
                <i className="fa fa-map-marker me-3"></i> sector 12, Pune, Maharashtra, India.
              </p>
              <Link className="mb-2 text-light d-block" to="tel:+91 9356xxxxxx">
                <i className="fa fa-phone me-3"></i>+91-9356xxxxxx
              </Link>
              <Link
                className="mb-2 text-light d-block"
                to="mailto:omkarmundhe46@gmail.com"
              >
                <i className="fa fa-envelope me-3"></i> omkarmundhe46@gmail.com
              </Link>
